"""blocks.py — core building blocks (DeformableFeatureAggregation, DenseDepthNet, AsymmetricFFN).
...
def linear_relu_ln(embed_dims, in_loops, out_loops, input_dims=None):
    """Helper: stack Linear-ReLU-LayerNorm blocks."""
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if pre_norm is not None:
            _, self.pre_norm = build_norm_layer(pre_norm, in_channels)
