"""models/map/map_blocks.py → coders/map.py

Map-related encoder/decoder classes:
- SparsePoint3DEncoder (POSITIONAL_ENCODING)
- SparsePoint3DRefinementModule (PLUGIN_LAYERS)
- SparsePoint3DKeyPointsGenerator (PLUGIN_LAYERS)
"""
...
class SparsePoint3DEncoder(BaseModule):
    """Positional encoding for sparse map points."""
...
class SparsePoint3DRefinementModule(BaseModule):
    """Refines map point coordinates and classifies point type."""
...
class SparsePoint3DKeyPointsGenerator(BaseModule):
    """Generates learnable 2D key points for map anchors."""
