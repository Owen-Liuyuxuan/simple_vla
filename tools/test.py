...
if __name__ == '__main__':
    # Dumps Python stacks on fatal signals (SIGSEGV/SIGBUS). Does not catch native-only crashes,
    # but helps when the fault involves the Python interpreter. See also: PYTHONFAULTHANDLER=1
